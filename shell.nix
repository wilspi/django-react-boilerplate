...
in
  ...
  stdenv.mkDerivation {
    name = "django-react-boilerplate-dev";
    ...
    '' + (
      ...
      [ ! -d '$PROJDIR/django-react-boilerplate-dev' ] && virtualenv django-react-boilerplate-dev && echo "SETUP django-react-boilerplate-dev: DONE"
      source django-react-boilerplate-dev/bin/activate
      python -m pip install -r requirements.txt
      # cd editor/frontend/ && npm install && npm run build && cd -
      echo "ENV: django-react-boilerplate-dev ACTIVATED";
    '';
  }
